#' @title Create GVA plot 2
#'
#' @description \code{GVA_plot_2} Creates Figure 3.2 from
...
#'   using \code{ggplot2}.
#'
#' @details \code{GVA_plot_2} takes as input a standardised long format GVA data
