...
#'   sector, one of: \code{
#'   c('creative','culture','digital','gambling','sport','telecoms','tourism',
#'   'UK', 'all_dcms') }, note that \code{all_dcms} is not the sum of the other
#'   sectors, due to overlap between sectors.} \item{year}{calendar year.}
