...
test_that(
  "figure3.2 produces expected plot",
  {

    # Check whether comparison file exists, and delete if so

    test_png <- file.path("figures", "test_figure3.2_test.png")
    ref_png <- file.path("figures", "test_figure3.2_reference.png")
    ...
    ggplot2::ggsave(
      width = 5,
      height = 5,
      filename = "figures/test_figure3.2_test.png"
    )
    ...
    visualTest::isSimilar(
      file = "figures/test_figure3.2_reference.png",
      fingerprint = visualTest::getFingerprint(
        file = "figures/test_figure3.2_test.png"
      ),
      threshold = 1e-3
    )
